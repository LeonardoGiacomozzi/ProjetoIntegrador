...
private static Connection conn = null;
	...
	public static Connection abreConexao() throws ConexaoException {
		try {
			...
			conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/tabacaria" //+ Configuracao.getPropriedade("banco") +
					+ "?useSSL=true&serverTimezone=America/Sao_Paulo", "root", "hericles");//Configuracao.getPropriedade("usuario"),Configuracao.getPropriedade("senha"));
			return conn;
		} catch (Exception e) {
