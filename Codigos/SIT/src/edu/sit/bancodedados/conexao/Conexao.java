...
private static Connection conn = null;
	...
	public static Connection abreConexao() throws ConexaoException {
		try {
			...
			conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/senai?useSSL=true&serverTimezone=America/Sao_Paulo", "root", "");
			//Implementar com os dados do nosso banco na hora de fazer os testes ^^^^^^^^^^^^^^^^^^^^^^^//
			return conn;
		} catch (Exception e) {
